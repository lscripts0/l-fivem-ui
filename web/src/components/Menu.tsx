      ...
      return (
        <Box
          sx={{
            ...
            width: '0.8rem',
            height: '0.8rem',
            border: `var(--hairline) solid ${item.checked ? colors.accent : isSelected ? 'rgba(255, 255, 255, 0.85)' : 'rgba(255, 255, 255, 0.4)'}`,
      ...
      {selectedItem?.description && (
        ...
        >
          <Typography sx={{ fontSize: '0.8rem', color: colors.text, lineHeight: 1.35 }}>
            {rich(selectedItem.description, colors.accent)}
          </Typography>
        </Box>
      )}
    </Box>
