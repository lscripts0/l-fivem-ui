if Config.VersionCheck then
    CreateThread(function()
        ...
        PerformHttpRequest('https://api.github.com/repos/lscripts0/l-fivem-ui/releases/latest', function(status, body)
            ...
            if outdated then
                print(('^3%s^7'):format(L('version_outdated', current, latest, 'https://github.com/lscripts0/l-fivem-ui/releases/latest')))
            else
                print(('^2%s^7'):format(L('version_current', current)))
            end
        end, 'GET', '', { ['User-Agent'] = 'l-fivem-ui' })
    end)
end
